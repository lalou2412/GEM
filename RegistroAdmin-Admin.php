...
<body>
	...
	<form action="RegistroAdmin-Admin.php" method="POST">
            ...
            $tipocuenta = "administrador";
				...
				try {
		                ...
		                if ($contra_f != $contra_confirmacion) {
		                    ...
		                    $sql = "INSERT INTO admin (CorreoElectronico, Contrasenia, TipoCuenta, Nombre) VALUES (:Correo_I, :Contra_I, :Tipo_cuenta_I, :Nombre_I)";
